...
<div class="container pt-4" style="max-width: 1120px; margin-top: 50px;">
    ...
    <div class="row justify-content-center">
        <div class="col-md-10 col-sm-11 margin-5">
            <div class="row justify-content-between <?php echo $Bg; ?> fontMenu p-2 my-2" id="info">
    ...
    <div class="row justify-content-center ligaSub text-justify" style="display: none;" id="dv_info">
